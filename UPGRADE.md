...
```bash
sh deploy/install-release.sh /home/nickc/linux-ai-agent-postgresql-v3.6.0-on-call-health.tar.gz /home/nickc
```
...
Schema 應為 `028`。到「值班健康檢查」重新檢查；若班次過長、相鄰休息不足或每週工時超標，應列出對應使用者、時間與風險說明。
